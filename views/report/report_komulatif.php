...
?>
  <tr>
    ...
    <td><?= format_date($date_awal) ?></td>
     <td> <?php
    $rit_komulatif = get_rit_komulatif($date_awal, $i_owner_id);
	$rit_komulatif = ($rit_komulatif) ? $rit_komulatif : 0;
	echo $rit_komulatif;
	?></td>
    <td>
    <?php
...
$total_rit = $total_rit + $rit_komulatif;
}
?>
<tr>
    <td colspan="2" bgcolor="#FFFF00"><strong>Total</strong><strong></strong></td>
     <td bgcolor="#FFFF00"><strong><?= $total_rit?></strong></td>
